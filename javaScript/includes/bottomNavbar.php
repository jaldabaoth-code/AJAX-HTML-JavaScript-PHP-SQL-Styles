...
<div class="bottom-nav">
    ...
    <a class="<?= ($currentPageName == 'introduction') ? 'active' : '' ?>" href="<?= $changeDirectory . 'javaScript/quests/introduction/index.php' ?>">
        <img class="nav-image" src="<?= $changeDirectory . 'assets/images/quest.png' ?>"> Introduction
    </a>
