...
<div class="bottom-nav">
    ...
    <a class="<?= ($pageName == 'array') ? 'active' : '' ?>" href="../../../php/quests/array/array.php">
    ...
    <a class="<?= ($pageName == 'arrayWorkshop') ? 'active' : '' ?>" href="../../../php/workshops/array/array.php">
        <img class="nav-image" src="../../../assets/images/workshop.png"> Array
    </a>
    <a class="<?= ($pageName == 'functionWorkshop') ? 'active' : '' ?>" href="../../../php/workshops/function/function.php">
        <img class="nav-image" src="../../../assets/images/workshop.png"> Function
    </a>
    <a class="<?= ($pageName == 'wildTemplateWorkshop') ? 'active' : '' ?>" href="../../../php/workshops/wildTemplate/wildTemplate.php">
        <img class="nav-image" src="../../../assets/images/workshop.png"> Wild Template
    </a>
    <a class="<?= ($pageName == 'wizardWorkshop') ? 'active' : '' ?>" href="../../../php/workshops/wizard/wizard.php">
